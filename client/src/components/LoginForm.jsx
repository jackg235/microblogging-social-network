...
import { login, logout } from '../slices/Authentification'
        ...
        if (error) {
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <div className="form-group text-left">
                    ...
                    <input onChange={this.handleChange} id='email' type="email" className="form-control" placeholder="Enter email" required/>
                </div>

                <div className="form-group text-left">
                    <label>Password</label>
                    <input onChange={this.handleChange} id='password' type="password" className="form-control" placeholder="Enter password" required/>
                </div>
                <div className="form-group text-left">
